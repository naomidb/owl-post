...
def get_triples(api):
    triples = """\
{%- if Article.new %}
<{{namespace}}{{ Article.n_number }}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://purl.org/ontology/bibo/AcademicArticle>  .
...
def run(connection, **params):
    if params['Article'].n_number:
        params['Article'].new = False
